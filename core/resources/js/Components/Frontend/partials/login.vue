<template>
    <div v-if="!withEmail">
        ...
        <div @click="togglewithEmail()"
            ...
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                ...
                <rect width="416" height="320" x="48" y="96" fill="none" stroke-linecap="round" stroke-linejoin="round"
    ...
    <div v-else>
        <div class="flex flex-col w-[90%] sm:w-[60%] mb-3 mt-2 m-auto ">


            <form @submit.prevent="submit">
                <div>
                    <label class="text-gray-900 text-sm" for="email">Your Email / Username</label>
                ...
                <div class="mt-4">
                    <label class="text-gray-900 text-sm" for="email">Your Password</label>
                ...
                <div class="flex items-center justify-end mt-4">
                    <Link  :href="route('password.request')"
                        class="underline text-sm text-gray-600 hover:text-gray-900 px-2">
                    Forgot your password?
                    </Link>

                    <button class=" px-4  border-[1px]   py-1 cursor-pointer border-gray-600 bg-white hover:border-gray-900 rounded-full font-poppins text-sm text-gray-800" :class="{ 'logging bg-greenish border-[0px]': form.processing }" :disabled="form.processing">
                       
                        <span v-if="!form.processing">SignIn</span>
                        <span v-if="form.processing" class="text-white">logging into Account ...</span>
                        
                    </button>
                </div>
            </form>
        </div>
        <div class="font-poppins items-center mb-6 text-sm flex justify-center">
