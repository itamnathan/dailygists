<template>
  <div class="overflow-auto" v-if="hidemenu">
    <div class="overflow-hidden overscroll-none bg-gray-900">
      <div class="px-6 pt-8">
      ...
      <div
        class="
          ...
          focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800
        ...
        "
      >
        <Link :href="route('home')" class="inline-block py-4 px-8 text-xs">
          Visit website</Link
        >
      </div>
      <div class="px-6 pt-4">
        ...
        <ul class="flex flex-col space-y-2">
          ...
          <Adminbaruldropdown>
            ...
            <template #li>
              <li>
                <Link
                  :href="route('backend.article.article.index')"
                  class="
                    inline-block
                    w-full
                    px-4
              ...
              <li>
                <Link
                  :href="route('backend.article.channel')"
                  class="
                    inline-block
                    w-full
                    px-4
              ...
              <li>
                <Link
                  :href="route('backend.article.tag')"
                  class="
                    inline-block
                    w-full
                    px-4
      ...
      <div class="px-2 py-2 bg-[#232529] flex items-center justify-between">
  ...
  <div
    class="bg-gray-900 rounded-lg m-1 p-1 relative grid content-between"
    v-else
  >
...
<script setup>
import Adminbaruldropdown from "@/Components/Adminbaruldropdown.vue";
