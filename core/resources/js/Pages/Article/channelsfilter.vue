      ...
      <div class="relative">
        ...
        >
          <div class="flex items-center justify-between space-x-2 px-2 py-2">
            ...
            <span class="text-lg"> Channel filter</span>
        ...
        >
          ...
          >
            ...
            >
              <Link
                :href="
                  route('articles', { channel: channel.slug, filter: filter })
                "
                :class="[
...
const channels = computed(() => usePage().props.value.channels);
